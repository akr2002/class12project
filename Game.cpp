...
void Game::menu()
{
	...
	while (true)
	{
		...
		std::cout << "Enter 2 to read rules!\n";
		std::cout << "Enter 3 to view record!\n";
		std::cout << "Enter 4 to quit game!\n";
		std::cout << "\nYour Choice : ";
		std::cin >> choice;
		...
		if (choice == 1)
		{
			while (true)
			{
				...
				int modeChoice;
				std::cout << "Enter 1 to play single player!\n";
				std::cout << "Enter 2 to play multi player!\n";
				std::cout << "\nYour Choice : ";
				std::cin >> modeChoice;
